        ...
        if l==1:
            ...
            if areacnt<2000: #significa que não existe objeto na região
                ...
                if arearatio<12 and not executado:
                    cv2.putText(frame,'0 = Mao Fechada',(0,50), font, 2, (0,0,255), 3, cv2.LINE_AA)
                    ...
                    cv2.putText(frame,'1 = Um dedo',(0,50), font, 2, (0,0,255), 3, cv2.LINE_AA)
                      
        elif l==2:
            cv2.putText(frame,'2 = Dois dedos',(0,50), font, 2, (0,0,255), 3, cv2.LINE_AA)

        elif l==3:
         
              if arearatio<27:
                    cv2.putText(frame,'3 = Tres dedos',(0,50), font, 2, (0,0,255), 3, cv2.LINE_AA)
                    
              else:
                    cv2.putText(frame,'ok',(0,50), font, 2, (0,0,255), 3, cv2.LINE_AA)
                           
        elif l==4:
            cv2.putText(frame,'4 = Quatro dedos',(0,50), font, 2, (0,0,255), 3, cv2.LINE_AA)
